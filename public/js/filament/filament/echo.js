      ...
      return (function (l) {
            ...
            for (var T = [], S = 0; S < P.length; S++) {
              ...
              if (C & 128) {
                ...
                if (C < 224) {
                  ...
                  var m = P[++S],
                    v = P[++S];
                  if ((m & 192) !== 128 || (v & 192) !== 128)
                    throw new Error(s);
                  (C = ((C & 15) << 12) | ((m & 63) << 6) | (v & 63)),
                    (x = 2048);
                } else if (C < 248) {
        ...
        function (l, h, a) {
          ...
          var Q = (function (e) {
              ...
              function t(n, r) {
                return (
                  e.call(this, setTimeout, Le, n, function (i) {
                    return r(), null;
                  }) || this
                );
              }
            ...
            Re = (function (e) {
              ...
              function t(n, r) {
                return (
                  e.call(this, setInterval, Ee, n, function (i) {
                    return r(), i;
                  }) || this
                );
              }
          ...
          function He(e) {
            return qe(e, function (t) {
              return (
                typeof t == 'object' && (t = ct(t)),
                encodeURIComponent(ke(t.toString()))
              );
            });
          }
          function Me(e) {
          ...
          var rn = (function () {
            ...
            hn = new tt(U({}, Bt, Jt)),
            ln = new tt(U({}, Xt, Jt)),
            fn = { ws: un, xhr_streaming: hn, xhr_polling: ln },
            ut = fn,
            pn = new tt({
              file: 'sockjs',
              urls: tn,
                  ...
                  var u = this.transport.createConnection(t, n, r, i),
                    ...
                    g = function (k) {
                      if (
                        ...
                        L < 2 * o.maxPingDelay &&
                          (o.manager.reportDeath(),
                          (o.pingDelay = Math.max(L / 2, o.minPingDelay)));
                      }
                    };
                        ...
                        switch (g.label) {
                          ...
                          case 2:
                            if ((g.sent(), this.pusher.user.user_data != null))
                              ...
                              return (
                                (_ = m.buildLogSuffix('authorizationEndpoint')),
                                A.error(
            ...
            Vn = (function () {
              ...
              return (
                (e.prototype.add = function (t, n) {
                  return (
                    this.channels[t] || (this.channels[t] = Qn(t, n)),
                    this.channels[t]
                  );
                }),
                      ...
                      k
                        ? (Qt(r),
                          o.length > 0
                            ...
                            : n(k))
                        : (sr(r, L.transport.name, j.now() - p), n(null, L));
                    });
                  return {
                    abort: function () {
                      _.abort();
          ...
          function sr(e, t, n) {
            ...
            if (r)
              try {
                r[St(e)] = ct({ timestamp: j.now(), transport: t, latency: n });
              } catch {}
          }
          function Qt(e) {
            var t = b.getLocalStorage();
          ...
          var lr = function (e, t, n) {
              var r = {};
              function i(ce, _i, mi, bi, wi) {
                var ue = n(e, ce, _i, mi, bi, wi);
                return (r[ce] = ue), ue;
              }
              var o = Object.assign({}, t, {
                ...
                L = i('ws', 'ws', 3, o, g),
                X = i('wss', 'ws', 3, u, g),
                pi = i('sockjs', 'sockjs', 1, p),
                ne = i('xhr_streaming', 'xhr_streaming', 1, p, k),
                di = i('xdr_streaming', 'xdr_streaming', 1, p, k),
                re = i('xhr_polling', 'xhr_polling', 1, p),
                vi = i('xdr_polling', 'xdr_polling', 1, p),
                ie = new Y([L], _),
                yi = new Y([X], _),
                gi = new Y([pi], _),
                oe = new Y([new it(ot(ne), ne, di)], _),
                se = new Y([new it(ot(re), re, vi)], _),
                ae = new Y(
                  [
                    new it(
                      ot(oe),
                      new kt([oe, new ht(se, { delay: 4e3 })]),
                      se
                    ),
                  ],
                  _
                ),
                xt = new it(ot(ae), ae, gi),
                Ot;
              return (
                t.useTLS
                  ? (Ot = new kt([ie, new ht(xt, { delay: 2e3 })]))
                  : (Ot = new kt([
                      ie,
                      new ht(yi, { delay: 2e3 }),
                      new ht(xt, { delay: 5e3 }),
                    ])),
                new ir(new hr(new it(ot(L), Ot, xt)), r, {
                  ttl: 18e5,
                  timeline: t.timeline,
                  useTLS: t.useTLS,
                })
                    ...
                    try {
                      return (
                        b
                          .createSocketRequest(
                            'POST',
                            Kt(Sr(this.location, this.session))
                          )
                          .start(t),
                        !0
                      );
              ...
              return (
                p
                  ? ((i = Object.assign(
                    ...
                    (_ = new Hr(t, r, o ? o.getAssistant(u) : u, i)))
                  : (_ = Fr),
                _
              );
            },
            ...
            return (
              'channelAuthorization' in e
                ...
                : ((n = {
                  ...
                  'authorizer' in e &&
                    (n.customHandler = Qr(t, n, e.authorizer))),
              n
            );
          }
          function ri(e, t) {
          ...
          var ci = ai,
            ...
            hi = (function (e) {
              ...
              return (
                ...
                (t.prototype._subscribeChannels = function () {
                  ...
                  (this.serverToUserChannel = new mt(
            ...
            ee = (function () {
              function e(t, n) {
                ...
                var o = function (u) {
                  return b.getDefaultStrategy(r.config, u, zr);
                };
        ...
        R(a, [
          ...
          },
          {
            ...
            value: function (s) {
              return (
                this.channels[s] ||
                  (this.channels[s] = new dt(this.pusher, s, this.options)),
                this.channels[s]
              );
            },
          },
            ...
            value: function (s) {
              return (
                this.channels['private-' + s] ||
                  (this.channels['private-' + s] = new Ii(
                    this.pusher,
                    'private-' + s,
                    this.options
                  )),
            ...
            value: function (s) {
              return (
                this.channels['private-encrypted-' + s] ||
                  (this.channels['private-encrypted-' + s] = new ji(
                    this.pusher,
                    'private-encrypted-' + s,
                    this.options
                  )),
        ...
        R(a, [
          ...
          },
          {
            ...
            value: function (s) {
              return (
                this.channels[s] ||
                  (this.channels[s] = new ve(this.socket, s, this.options)),
                this.channels[s]
              );
            },
          },
          {
            ...
            value: function (s) {
              return (
                this.channels['private-' + s] ||
                  (this.channels['private-' + s] = new ye(
                    this.socket,
                    'private-' + s,
                    this.options
                  )),
          ...
          },
          {
            ...
            value: function (s) {
              return (
                this.channels['presence-' + s] ||
                  (this.channels['presence-' + s] = new qi(
                    this.socket,
                    'presence-' + s,
                    this.options
                  )),
      ...
      return (
        R(l, [
          ...
          },
          {
            key: 'connect',
            value: function () {
              this.options.broadcaster == 'reverb'
                ? (this.connector = new pe(
                    st(st({}, this.options), { cluster: '' })
                  ))
          ...
          },
          {
            ...
            value: function () {
              typeof Vue == 'function' &&
                ...
                (typeof Turbo > 'u' ? 'undefined' : At(Turbo)) === 'object' &&
