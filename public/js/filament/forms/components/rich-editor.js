...
var ut = (I, g, x) => (
  ...
  at(
    g || !I || !I.__esModule
      ? Z(x, 'default', { value: I, enumerable: !0 })
      : x,
    I
  )
);
  ...
  (function () {}).call(q),
    ...
    (function (I) {
        ...
        return n._state === 0
          ...
          : ((n._handled = !0),
            void u(function () {
              ...
              if (c === null)
                return void (n._state === 1 ? h : o)(p.promise, n._value);
              var v;
              try {
                v = c(n._value);
              } catch (t) {
      ...
      function h(n, p) {
        try {
          ...
          if (p && (typeof p == 'object' || typeof p == 'function')) {
            var c = p.then;
            if (p instanceof b)
              return (n._state = 3), (n._value = p), void e(n);
      ...
      function e(n) {
        ...
        for (var p = 0, c = n._deferreds.length; c > p; p++)
          y(n, n._deferreds[p]);
        n._deferreds = null;
      }
      function a(n, p, c) {
      ...
      x ||
            ...
            (t.prototype = {
              ...
              addListeners_: function (D) {
                ...
                R.attributes && D.addEventListener('DOMAttrModified', this, !0),
                  ...
                  R.childList &&
                    D.addEventListener('DOMNodeInserted', this, !0),
              ...
              removeListeners_: function (D) {
                var R = this.options;
                R.attributes &&
                  D.removeEventListener('DOMAttrModified', this, !0),
                  R.characterData &&
        ...
        (function () {
          ...
          var y = (function () {
            ...
            return (
              a.initEvent('foo', !0, !0), a.preventDefault(), a.defaultPrevented
            );
          })();
          if (!y) {
          ...
          if (
            ((!window.CustomEvent ||
              (o && typeof window.CustomEvent != 'function')) &&
          ...
          function h(i, u, s) {
            ...
            if (!n)
              for (n = i.firstChild; n && n.nodeType !== Node.ELEMENT_NODE; )
                n = n.nextSibling;
            for (; n; )
              u(n, s) !== !0 && h(n, u, s), (n = n.nextElementSibling);
            return null;
          }
          function o(i, u) {
        ...
        window.CustomElements.addModule(function (b) {
          ...
          function a() {
            L = !1;
            for (var E, w = O, k = 0, T = w.length; T > k && (E = w[k]); k++)
              E();
            O = [];
          }
          function d(E) {
          ...
          function t(E) {
            for (
              E = window.wrap(E), E || (E = window.wrap(document));
              E.parentNode;
          ...
          function l(E) {
            (E = window.wrap(E)),
              f.dom &&
                console.group('upgradeDocument: ', E.baseURI.split('/').pop());
        ...
        window.CustomElements.addModule(function (b) {
          ...
          function e(i, u, s) {
            for (var n = {}, p = u; p !== s && p !== HTMLElement.prototype; ) {
              for (
                var c, v = Object.getOwnPropertyNames(p), t = 0;
                (c = v[t]);
                t++
              )
                n[c] ||
          ...
          var d = b.flags;
          (b.upgrade = y),
            (b.upgradeWithDefinition = h),
            (b.implementPrototype = o);
        }),
        window.CustomElements.addModule(function (b) {
          function y(E, w) {
            var k = w || {};
              ...
              return (
                ...
                (h.prototype.inspect = function () {
                  ...
                  return (
                    (e = function () {
                      var i, u, s;
                      (u = (i = this.contentsForInspection()) != null ? i : {}),
                        (s = []);
...
`
              ...
              (x = function (y, h) {
                ...
                for (
                  ;
                  e > o + 1 && y.charAt(e - 1).isEqualTo(h.charAt(a - 1));
          ...
          function () {
            ...
            (g.registerElement = function (d, i) {
              ...
              (e = function (d) {
                ...
                for (i in d)
                  (s = d[i]),
                    (u[i] = typeof s == 'function' ? { value: s } : s);
                return u;
              }),
              (a = (function () {
                var d;
          ...
          function () {
            ...
            g.extend({
              getDOMSelection: function () {
                var y;
                return (
                  (y = window.getSelection()), y.rangeCount > 0 ? y : void 0
                );
              },
              getDOMRange: function () {
                var y, h;
                return (y =
                  (h = g.getDOMSelection()) != null
                    ? h.getRangeAt(0)
                    : void 0) && !x(y)
                  ? y
                  : void 0;
              ...
              (g.Hash = (function (h) {
                ...
                return (
                  ...
                  (o.prototype.getKeysCommonToHash = function (s) {
                    var n, p, c, v, t;
                    for (
                      s = e(s), v = this.getKeys(), t = [], n = 0, c = v.length;
                      c > n;
                      n++
                    )
        ...
        <input type="button" class="trix-button trix-button--dialog" value="` +
          ...
          function () {
            g.config.input = {
              level2Enabled: !0,
              getLevel: function () {
                return this.level2Enabled && g.browser.supportsInputEvents
                  ? 2
                  : 0;
              },
              ...
              (g.MutationObserver = (function (s) {
                ...
                return (
                  ...
                  (n.prototype.mutationIsSignificant = function (r) {
                    ...
                    for (
                      m = this.nodesModifiedByMutation(r), l = 0, A = m.length;
                      A > l;
                      l++
                    )
...
` && !C),
                  ...
                  (l.prototype.events = {
                    ...
                    input: function (f) {
                      return (
                        (this.inputSummary.didInput = !0), f.stopPropagation()
                      );
                    },
                  }),
                  (l.prototype.keys = {
...
`);
                  ...
                  (u = function (t) {
                    ...
                    return (
                      a.call(
                        (r = (l = t.dataTransfer) != null ? l.types : void 0) !=
                          null
                          ? r
                          : [],
                        'Files'
          ...
          function () {
            ...
            (y = g.makeElement),
              ...
              (b = function (e, a) {
                var d;
                return (
                  (d = y('div')), (d.innerHTML = e ?? ''), d.querySelector(a)
                );
              });
          }.call(this),
          function () {
                          ...
                          v.push(
                            function () {
                              ...
                              for (
                                ...
                                (n = A[r]),
                                  f.push(this.shadowElement.appendChild(n));
                              return f;
                            }.call(this)
                          );
                      return v;
                ...
                return (
                  ...
                  (u.prototype.didFocus = function () {
                    ...
                    return (
                      ...
                      (n =
                        (p = this.blurPromise) != null ? p.then(s) : void 0) !=
                      null
                        ? n
                        : s()
                    );
                ...
                return (
                  ...
                  (d.prototype.showDialog = function (f) {
                    ...
                    return (
                      (m = t(S)) &&
                        (O = l(S, f)) &&
                        ((O.value = (w = this.attributes[m]) != null ? w : ''),
                        O.select()),
            ...
            g.Attachment = (function (h) {
              ...
              return (
                ...
                (o.prototype.isPending = function () {
                  return (
                    this.file != null && !(this.getURL() || this.getHref())
                  );
                }),
            ...
            (x = g.spliceArray),
              (g.SplittableList = (function (o) {
                ...
                return (
                  ...
                  (e.prototype.insertSplittableListAtPosition = function (
                    u,
                    s
                  ) {
                    var n, p, c;
                    ...
                    return {
                      objects:
                        ...
                        function () {
                          var s, n, p, c;
                          for (
                            p = this.objects, c = [], s = 0, n = p.length;
                            n > s;
                            s++
                          )
...
`,
                  ...
                  (l = function (m) {
                    ...
                    return (
                      ...
                      S === 0
                        ? !1
                        : ((C = m.getTextAtRange([S - 1, S])), C.isBlockBreak())
                    );
                  }),
                  (A = function (m) {
              ...
              (g.HTMLSanitizer = (function (d) {
                ...
                return (
                  ...
                  (i.prototype.elementIsntSerializable = function (c) {
                    return (
                      c.getAttribute('data-trix-serialize') === 'false' && !x(c)
                    );
                  }),
                  (p = function (c) {
                    var v, t, r, l, A;
                ...
                return (
                  ...
                  (t.prototype.processNode = function (w) {
                    switch (w.nodeType) {
                      ...
                      case Node.ELEMENT_NODE:
                        return (
                          this.appendBlockForElement(w), this.processElement(w)
                        );
                    }
                  }),
...
`)
                        : (T !== this.containerElement &&
                          ...
                          ? void 0
                          : ((this.currentBlock =
                              this.appendBlockForAttributesWithElement(k, T)),
...
`)
                          : ((this.currentBlock =
                              this.appendBlockForAttributesWithElement(k, w)),
                    ...
                    for (T = []; w && w !== this.containerElement; ) {
                      ...
                      for (k in P)
                        (N = P[k]),
                          N.parse !== !1 &&
                            u(w) === N.tagName &&
                            ((typeof N.test == 'function' && N.test(w)) ||
                              !N.test) &&
                            (T.push(k),
                  ...
                  (u.prototype.copyUsingObjectMap = function (n) {
                    ...
                    return (
                      (c = function () {
                        var t, r, l, A;
                        for (
                          l = this.getBlocks(), A = [], t = 0, r = l.length;
                          r > t;
                          t++
                        )
                          (p = l[t]),
                            A.push(
                              (v = n.find(p)) ? v : p.copyUsingObjectMap(n)
                            );
                        return A;
                      }.call(this)),
...
`),
                          L
                            ? (v = this.blockList.editObjectAtIndex(
                                ...
                                function (_) {
                                  return _.copyWithText(
                                    _.text.removeTextAtRange([w, w + 1])
                                  );
                                }
                              ))
                            : ((m = t.text.getTextAtRange([0, A])),
                              ...
                              (P =
                                O &&
                                t.getAttributeLevel() >= D.getAttributeLevel()),
                  ...
                  (u.prototype.removeLastListAttributeAtRange = function (
                    n,
                    p
                  ) {
                    var c;
                  ...
                  (u.prototype.removeLastTerminalAttributeAtRange = function (
                    n
                  ) {
                    var p;
                    return (
                  ...
                  (u.prototype.expandRangeToLineBreaksAndSplitBlocks =
                    function (n) {
...
`
                  ...
                  (u.prototype.convertLineBreaksToBlockBreaksInRange =
                    function (n) {
                      var p, c, v;
                      return (
                        (c = (n = y(n))[0]),
                      ...
                      h(n)
                        ...
                        : ((v = []),
                          ...
                          this.eachBlockAtRange(n, function (t, r) {
                            return r[0] !== r[1]
                              ? (v.push(t.text.getCommonAttributesAtRange(r)),
                                p.push(s(t)))
                              : void 0;
                          }),
                  ...
                  (u.prototype.getAttachmentPieces = function () {
                    ...
                    return (
                      ...
                      this.blockList.eachObject(function (p) {
                        var c;
                        return (
                          (c = p.text), (n = n.concat(c.getAttachmentPieces()))
                        );
                      }),
                      n
                    );
                  ...
                  (u.prototype.findRangesForBlockAttribute = function (n) {
                    var p, c, v, t, r, l, A;
                    for (
                      r = 0, l = [], A = this.getBlocks(), c = 0, v = A.length;
                      v > c;
                      c++
                    )
                      (p = A[c]),
...
`)
                  ...
                  (c.prototype.replaceHTML = function (t) {
                    var r, l, A;
                    return (
                      (r = g.Document.fromHTML(t).copyUsingObjectsFromDocument(
                        this.document
                      )),
                  ...
                  (c.prototype.setTextAttribute = function (t, r) {
                    ...
                    if ((A = this.getSelectedRange()))
                      return (
                        ...
                        f !== l
                          ? this.setDocument(
                              this.document.addAttributeAtRange(t, r, A)
                            )
                          : t === 'href'
                            ? ((m = g.Text.textForStringWithAttributes(r, {
                                href: r,
                              })),
                              this.insertText(m))
                            : void 0
                  ...
                  (c.prototype.setBlockAttribute = function (t, r) {
                    ...
                    if ((A = this.getSelectedRange()))
                      return this.canSetCurrentAttribute(t)
                        ? ((l = this.getBlock()),
                          this.setDocument(
                            this.document.applyBlockAttributeAtRange(t, r, A)
                          ),
                          this.setSelection(A))
                        : void 0;
                  }),
                  ...
                  (c.prototype.decreaseListLevel = function () {
                    ...
                    return (
                      ...
                      this.setDocument(
                        this.document.removeLastListAttributeAtRange([m, A])
                      )
                    );
                  }),
                  (c.prototype.updateCurrentAttributes = function () {
                    ...
                    if ((m = this.getSelectedRange({ ignoreLock: !0 }))) {
                      for (
                        ...
                        (t = f[l]),
                          r[t] || this.canSetCurrentAttribute(t) || (r[t] = !1);
...
` &&
                            ((this.document =
                              this.document.insertBlockBreakAtRange(i[1])),
...
` &&
                            ((this.document =
                              this.document.insertBlockBreakAtRange(i[0])),
              ...
              return (
                ...
                (b.prototype.loadHTML = function (h) {
                  return (
                    h == null && (h = ''),
                    this.loadDocument(
                      g.Document.fromHTML(h, { referenceElement: this.element })
                    )
                  );
                }),
            ...
            (x = g.elementContainsNode),
              ...
              (g.LocationMapper = (function () {
                ...
                return (
                  ...
                  (n.prototype.findContainerAndOffsetFromLocation = function (
                    r
                  ) {
                    var l, A, f, m, C;
                    ...
                    if (
                      ...
                      if (i(A))
                        ...
                        if (
                          ((l = A.parentNode), !o(A.previousSibling) && !h(l))
                        )
                          for (
                            ;
                            A === l.lastChild &&
                  ...
                  (n.prototype.findAttachmentElementParentForNode = function (
                    r
                  ) {
                ...
                return (
                  ...
                  (a.prototype.notifySelectionManagersOfSelectionChange =
                    function () {
                      var i, u, s, n, p;
                      for (
                        s = this.selectionManagers, n = [], i = 0, u = s.length;
                        u > i;
                        i++
                      )
            ...
            (y = g.getDOMSelection),
              ...
              (g.SelectionManager = (function (c) {
                ...
                return (
                  ...
                  (v.prototype.createLocationRangeFromDOMRange = function (
                    t,
                    r
                  ) {
                    var l, A;
                    ...
                    return (
                      ...
                      (l = (function () {
                        ...
                        for (
                          ...
                          (t = C[f]),
                            S.push(
                              h(t, { onElement: document, withCallback: r })
                            );
                        return S;
                      })())
                    );
                  ...
                  (v.prototype.createDOMRangeFromLocationRange = function (t) {
                    ...
                    return (
                      ...
                      (l = d(t)
                        ? A
                        : (f = this.findContainerAndOffsetFromLocation(t[1])) !=
                            null
                          ? f
                          : A),
                      A != null && l != null
            ...
            (y = g.rangeIsCollapsed),
              ...
              (g.EditorController = (function (d) {
                ...
                return (
                  ...
                  (i.prototype.compositionDidChangeCurrentAttributes =
                    function (s) {
                      return (
                  ...
                  (i.prototype.compositionDidPerformInsertionAtRange =
                    function (s) {
                  ...
                  (i.prototype.compositionDidStopEditingAttachment =
                    function () {
                      return (
                  ...
                  (i.prototype.inputControllerDidReceiveDragOverPoint =
                    function (s) {
                            ...
                            return (
                              (C = (function () {
                                ...
                                for (
                                  ...
                                  (f = O[S]),
                                    f.contains(l) || D.push(f.textContent);
                                return D;
                              })()),
                              (m = C.join(' '))
  ...
  margin-right: -1px !important;
                      ...
                      resetBubbled: function (l) {
                        ...
                        if (
                          !l.defaultPrevented &&
                          l.target ===
                            ((A = this.inputElement) != null ? A.form : void 0)
                        )
                          return this.reset();
                      },
