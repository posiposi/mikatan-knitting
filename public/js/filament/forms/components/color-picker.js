...
var d = (e) => {
  ...
  A = ({ h: e, s: t, v: r, a: o }) => {
    ...
    let s = Math.floor(e),
      ...
      N = s % 6;
    return {
      r: n([r, i, a, a, l, r][N] * 255),
      g: n([l, r, r, i, a, a][N] * 255),
      b: n([a, a, l, r, r, i][N] * 255),
      a: n(o, 2),
    };
  },
  B = (e) => {
...
var O = (e, t) => {
  ...
  K = (e, t) => (e.toLowerCase() === t.toLowerCase() ? !0 : O(b(e), b(t)));
var Q = {},
  $ = (e) => {
    let t = Q[e];
    return (
...
var m = !1,
  I = (e) => 'touches' in e,
  ut = (e) => (m && !I(e) ? !1 : (m || (m = I(e)), !0)),
  W = (e, t) => {
    let r = I(t) ? t.touches[0] : t,
  ...
  u = class {
    ...
    handleEvent(t) {
      switch (t.type) {
        case 'mousedown':
        case 'touchstart':
          if ((t.preventDefault(), !ut(t) || (!m && t.button != 0))) return;
...
var T = Symbol('same'),
  ...
  p = class extends HTMLElement {
    ...
    handleEvent(t) {
      ...
      this[_](o);
      let s;
      !O(o, r) && !this[T]((s = this.colorModel.fromHsva(o))) && this[R](s);
    }
    [T](t) {
    ...
    [R](t) {
      (this[et] = t), f(this, 'color-changed', { value: t });
    }
  };
var ht = {
    defaultColor: '#000',
